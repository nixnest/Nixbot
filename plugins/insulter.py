...
__copyright__ = 'Copyright (C) 2009 by Ryan McGreal. Licenced under GPL ' + \
                'version 2. http://www.gnu.org/licenses/gpl-2.0.html'

config = "Returns an insult"
...
def generate_insult(target):
    ...
    words = (
        ('Artless', 'Bawdy', 'Beslubbering', 'Bootless', 'Churlish',
         ...
         'Mewling', 'Paunchy', 'Pribbling', 'Puking', 'Puny', 'Quailing',
        ...
        ('Apple-john', 'Baggage', 'Barnacle', 'Bladder', 'Boar-pig', 'Bugbear',
         ...
         'Haggard', 'Harpy', 'Hedge-pig', 'Horn-beast', 'Huggermugger',
         'Jolt-head', 'Lewdster', 'Lout', 'Maggot-pie', 'Malt-worm', 'Mammet',
         'Measle', 'Minnow', 'Miscreant', 'Mold-warp', 'Mumble-news',
         'Nut-hook', 'Pigeon-egg', 'Pignut', 'Puttock', 'Pumpion', 'Rats-bane',
         'Scut', 'Skains-mate', 'Strumpet', 'Varlot', 'Vassal', 'Whey-face',
         'Wagtail',),
        )
    insult_list = (
    ...
    return '%s, thou art %s %s, %s %s.' % (target, article, insult_list[0],
                                           insult_list[1], insult_list[2])
